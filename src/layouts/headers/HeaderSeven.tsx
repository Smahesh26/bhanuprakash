                     ...
                     <div className="col-12">
                        <div className="tgmenu__wrap">
                           <nav className="tgmenu__nav">
                              <div className="logo">
                                 <Link href="/"><h5>Dr.Bhanu Prakash</h5></Link>
                              </div>
                                       ...
                                       <div className="tgmenu__categories select-grp-two d-none d-md-block">
                                          <div className="dropdown">
                                             ...
                                             <ul className="dropdown-menu">
                                                <li><Link className="dropdown-item" href="/courses">Anatomy</Link></li>
                                                <li><Link className="dropdown-item" href="/courses">Biochemistry
                                                </Link></li>
                                                <li><Link className="dropdown-item" href="/courses">Physiology
                                                </Link></li>
                                                <li><Link className="dropdown-item" href="/courses">Community Medicine</Link></li>
                                                <li><Link className="dropdown-item" href="/courses">Pharmacology
                                                </Link></li>
                                                <li><Link className="dropdown-item" href="/courses">Pathology
                                                </Link></li>
                                                <li><Link className="dropdown-item" href="/courses">Microbiology
